...
This project demonstrates how messy, inconsistent real-world data can be transformed into a clean, structured, and analysis-ready dataset using Python.

It focuses on practical data cleaning techniques such as handling missing values, fixing inconsistent formats, removing outliers, and preparing data for data analysis and machine learning workflows.

---

## 🎯 Project Objective

To simulate real-world data quality issues and showcase hands-on skills in cleaning, preprocessing, and transforming raw datasets into usable formats.
...
* Converting incorrect data types (`object → int/float`)
...
### 📌 Example 3: Removing Outliers (IQR Method)
